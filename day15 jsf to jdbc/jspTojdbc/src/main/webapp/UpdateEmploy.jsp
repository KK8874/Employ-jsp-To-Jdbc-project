...
<form method ="get" action="UpdateEmploy.jsp">
		<center>
		    Employ No:
			<input type="text" name="empno" value=<%=employ.getEmpno() %>><br/><br/>
			Employ Name:
			<input type="text" name="name" value=<%=employ.getName() %>><br/>
			Employ Department:
			<input type="text" name="dept" value=<%=employ.getDept() %>><br/>
			Employ Designation:
			<input type="text" name="desig" value=<%=employ.getDesig() %>><br/>
			Employ Basic:
			<input type="text" name="basic" value=<%=employ.getBasic() %>><br/>
